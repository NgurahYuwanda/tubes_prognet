        ...
        fetch('http://127.0.0.1:8000/api/Barang')
            ...
            .then(data => {
                ...
                data.forEach(item => {
                    ...
                    barangCell.textContent = item.namabarang;
                    hargaCell.textContent = item.harga;
                    stokCell.textContent = item.stok;
                    satuanCell.textContent = item.satuan_id;
                    ...
                    editButton.addEventListener('click', () => {
                        ...
                        window.location.href = `/Barang/${item.id}`
                    });
                    ...
                    deleteButton.addEventListener('click', () => {
                        fetch(`http://127.0.0.1:8000/api/Barang/${item.id}`, {
                                method: 'DELETE'
                            })
                            .then(response => {
                                if (response.ok) {
